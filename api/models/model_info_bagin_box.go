...
// Información sobre el bag in box
type InfoBaginBox struct {
	Tipo string `json:"tipo,omitempty"`

	Dimensiones *InfoBaginBoxDimensiones `json:"dimensiones,omitempty"`
	// Material del que está hecho el bag in box
