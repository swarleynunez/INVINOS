...
// Sistema de producción ecológica biodinámico
type SistProduccionBiodinamico struct {
	// Tipo de certificado
	Tipo string `json:"tipo_bio,omitempty"`

	Certificado *CertTemplate `json:"certificado_bio,omitempty"`
}
